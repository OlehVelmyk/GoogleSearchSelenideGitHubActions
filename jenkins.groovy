...
//              set JOB_URL=${env.JOB_URL}
              ...
              set FULL_MESSAGE={\\"chat_id\\":\\"%TELEGRAM_CHAT_ID%\\",\\"text\\":\\"${slackEmoji} '%JOB_NAME%' completed!!! %BUILD_RESULT% Branch: %BRANCH_NAME%. Browser: %BROWSER_NAME%. Report is here: http://172.25.160.1:8090/job/%JOB_NAME%/%BUILD_NUMBER%/allure/\\",\\"parse_mode\\":\\"HTML\\"}
